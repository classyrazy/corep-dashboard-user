        ...
        <div class="font-inter" v-if="slotProps.userStore">
            ...
            <header class="w-full flex justify-between items-center mb-6">
                <div class="w-full max-w-lg">
                    <v-input class="dark:bg-db-pry-dark min-w-[70%] block py-2 px-3 dark:text-white rounded-lg"
                        size="x-small" style-type="search" :icon="SearchIcon" placeholder="Search for Courses" full
                        iconLeft :icon-color="slotProps.mode? '#ffff': '#212939'"></v-input>
                ...
                <div class="flex items-center mx-2">
                    ...
                    <router-link to="/settings/user">
                        <div class="flex items-center font-inter text-sm">
                            <p class="dark:text-white text-db-pry-dark mr-2" v-if="slotProps.userStore">{{slotProps.userStore.username}}</p>
