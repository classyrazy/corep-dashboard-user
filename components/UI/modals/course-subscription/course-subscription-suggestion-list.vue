<template>
    <div class="dark:bg-db-pry px-4 py-4 relative mx-4 rounded-lg min-h-[300px] max-h-[400px] overflow-y-auto">
      <h3 class="text-xl dark:text-white mb-4 font-semibold" v-if="!searchTerm">Recommended From Your timetable</h3>
